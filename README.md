...
Thanks for [Max Stepanov](https://github.com/mast), [Zoran Pandovski](https://github.com/ZoranPandovski), [Jorge Torres](https://github.com/torrmal) for their contributions to Mindsdb Server, even though their contributions to those particular components may not show up in the commit history.
