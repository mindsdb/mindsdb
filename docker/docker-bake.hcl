  ...
  matrix = {
    item = [
      ...
      },
      {
        ...
        name = "cloud"
        extras = ".[mysql,statsforecast-extra,neuralforecast-extra,timegpt,mssql,mssql-odbc,gmail,snowflake,clickhouse,bigquery,elasticsearch,s3,databricks,oracle,opentelemetry,langfuse,jira,salesforce,gong,hubspot,netsuite,agents,kb] darts datasetsforecast transformers"
        target = ""
      },
      {
        name = "cloud-cpu"
