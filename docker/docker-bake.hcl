  ...
  matrix = {
    item = [
      ...
      },
      {
        ...
        name = "cloud"
        extras = ".[mysql,statsforecast-extra,neuralforecast-extra,mssql,mssql-odbc,snowflake,bigquery,databricks,oracle,opentelemetry,langfuse,salesforce,hubspot,netsuite,shopify,agents,kb,pgvector] darts datasetsforecast transformers"
        target = ""
      },
      {
        name = "cloud-cpu"
