...
target "cloud" {
  ...
  tags = get_tags("cloud")
  args = {
    EXTRAS = ".[lightwood,huggingface,statsforecast-extra,neuralforecast-extra,timegpt,surrealdb,mssql,youtube,ignite,gmail,pgvector,llama_index] darts datasetsforecast"
  }
}
