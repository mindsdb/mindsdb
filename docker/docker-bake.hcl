...
target "images" {
  ...
  matrix = {
    item = [
      ...
      {
        name = "cloud"
        extras = ".[lightwood,huggingface,statsforecast-extra,neuralforecast-extra,timegpt,surrealdb,mssql,youtube,ignite,gmail,pgvector,llama_index,writer,rag,github,snowflake,clickhouse,couchbase,twelve_labs,ludwig] darts datasetsforecast"
        target = ""
      },
      {
        name = "cloud-data"
