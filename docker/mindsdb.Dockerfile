...
ARG EXTRAS
RUN pip install lightwood==23.8.1.0 lightwood[audio]==23.8.1.0 lightwood[extra_ts]==23.8.1.0 lightwood[extra]==23.8.1.0 lightwood[image]==23.8.1.0 lightwood[xai]==23.8.1.0 type_infer==0.0.17
