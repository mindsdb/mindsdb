...
DBeaver is a database tool that allows you to connect to and work with various
database engines. You can download it [here](https://dbeaver.io/).
...
<Accordion title= "Connecting to your local MindsDB">
...
![](/assets/sql/dbeaver_5.png)

<Tip>

**Whitelist MindsDB Cloud IP address**

If you need to whitelist the MindsDB Cloud
IP address to gain access to your database, reach out to the MindsDB team, and
we'll share the MindsDB Cloud static IP address with you.
