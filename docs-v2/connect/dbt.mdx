...
DBT is a development framework that facilitates data transformation processes.
You can read more [here](https://www.getdbt.com/).
...
adapter by executing this command: `#!bash pip install dbt-mindsdb`.
...
**What MindsDB Supports**

Currently, MindsDB supports only user/password
...
<Warning>Each time DBT is run, the results table is overwritten.</Warning>
