...
Metabase is open-source software that facilitates data analysis. It lets you
visualize your data easily and intuitively. Now that MindsDB supports the MySQL
binary protocol, you can connect it to Metabase and see the forecasts by
...
4. Fill in the form using the following data:
   ...
   ![](/assets/metabase_add_database.png)

5. Click on _Save_.

Now you're connected!

![](/assets/metabase_connected.png)
...
![](/assets/metabase_run_query_show_tables.png)
...
![](/assets/metabase_run_query_failure.png)
...
![](/assets/metabase_run_query_home_rentals.png)
