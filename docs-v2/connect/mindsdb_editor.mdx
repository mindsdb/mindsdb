...
MindsDB provides a SQL Editor, so you don't need to download additional SQL
clients to connect to MindsDB.
...
<AccordionGroup>
    ...
    <Accordion title="Self-Hosted Local Deployment">
    ...
    Immediately after, your browser automatically opens the MindsDB SQL Editor. In case if it doesn't, visit the URL [http://127.0.0.1:47334/](http://127.0.0.1:47334/) in your browser of preference.

    </Accordion>

    <Accordion title= "MindsDB Cloud">
...
<img height="200" src="/assets/cloud/gui_query.png" />
