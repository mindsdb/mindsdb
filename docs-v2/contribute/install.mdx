...
description: Installing MindsDB for Development
---

Before you contribute to MindsDB you will need to install it. There are a few
options to do that by installing from source, PyPi or using our Docker image.
Our preferred method for development is source install.

### Installing MindsDB from the source

Before installing MindsDB make sure you have `Git` and `Python 3.7.x or 3.8.x`
versions installed.

1. Fork MindsDB Repository from
