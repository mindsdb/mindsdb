...
We use [GitHub issues](https://github.com/mindsdb/mindsdb/issues) to track
`bugs` and `features` requests. Before reporting a new issue or requesting a new
feature, please make sure that it is not already reported.
...
- Additional useful information for the team as links, references or anything
  that will give us more context.
