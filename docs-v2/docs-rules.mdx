...
description: Style Guide for MindsDB Documentation
---
...
!!! note If the output is not a table, remove the output table from above and
place your output message there.
