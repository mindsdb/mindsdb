---
title: Connecting Databases to MindsDB in Mongo
sidebarTitle: Databases
description: Integrations, or external databases, provide data to be used for making forecasts.
---

Here, we use the `databases.insertOne()` method to connect the
