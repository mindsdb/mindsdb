---
title: Stats()
description: Getting the Statistics
---

## The `stats()` Method

The `stats()` method is used to display the attributes of an existing model. It
accepts the `{scale: "attribute"}` object as an argument.
...
If you're unsure how to `#!sql DESCRIBE` your model or understand the results,
feel free to ask us at the community
