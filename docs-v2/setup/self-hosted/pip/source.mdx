---
title: Setup for Sourcecode via pip
description: "This section describes how to deploy MindsDB from the source code. It is the
preferred way to use MindsDB if you want to contribute to our code or debug
MindsDB."
---
...
6. Now, you can access the following:
   ...
   === "MindsDB APIs" `http://127.0.0.1:47334/api`

   === "MindsDB Studio" `http://127.0.0.1:47334/`

   === "MindsDB Studio using MySQL"
   `bash mysql -h 127.0.0.1 --port 3306 -u mindsdb -p `
