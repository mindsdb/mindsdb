...
Given the following query to list all predictors by name
...
Execute the `DROP PREDICTOR` statement as:
...
Validate that the model has been deleted by listing again all predictors by
name:
