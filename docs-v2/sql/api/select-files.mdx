---
title: SELECT * FROM files.[file_name] Statement
sidebarTitle: SELECT from files
description: "The SELECT FROM files statement is used to select data from a file."
---
...
[`CREATE PREDICTOR`](/sql/create/predictor/) from the uploaded file.
...
the [`CREATE PREDICTOR` command here](/sql/create/predictor/).
