...
sidebarTitle: Body Fat Prediction
...
Community Author: [Contip](https://github.com/contip)
...
the [JOIN command](https://docs.mindsdb.com/sql/api/join/), which allows for the
