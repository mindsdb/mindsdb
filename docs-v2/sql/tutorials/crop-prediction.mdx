...
Dataset:
[Crop recomendation Data](https://www.kaggle.com/atharvaingle/crop-recommendation-dataset)

Community Author: [pixpack](https://github.com/pixpack)
...
In this tutorial, you will learn how to predict the best crop type based on
field parameters using **MindsDB**.
...
[database.](https://docs.mindsdb.com/sql/create/databases/)
...
[here](https://docs.mindsdb.com/setup/cloud/). Alternatively, you can also use
...
[JOIN clause documentation](https://docs.mindsdb.com/sql/api/join/) for more
information.
