...
Community Author:
[Chandre Tosca Van Der Westhuizen](https://github.com/chandrevdw31)
...
1. A MindsDB instance. Check out the installation guide for
   ...
   [PyPi](https://docs.mindsdb.com/setup/self-hosted/pip/windows/). You can also
   use [MindsDB Cloud](https://docs.mindsdb.com/setup/cloud/).
...
- PARAMETERS = \{ - "user": " ", --- Your database user. - "password": " ", ---
  Your password. - "host": " ", --- host, it can be an ip or an url. - "port":
  "5432", --- common port is 5432. - "database": " " --- The name of your
  database \*optional. }
