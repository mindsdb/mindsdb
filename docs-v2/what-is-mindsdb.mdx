...
description: "Data that lives in your database is a valuable asset. MindsDB enables you to use
...
<img height="200" src="/assets/sql/income_vs_debt.png" />
...
<img height="200" src="/assets/sql/income_vs_debt_known_value.png" />
...
When the `WHERE` clause condition is not fulfilled for any of the rows, no value
is returned.

<img height="200" src="assets/sql/income_vs_debt_unknown_value.png" />
...
MindsDB provides the [`#!sql CREATE PREDICTOR`](/sql/create/predictor/)
...
<img height="200" src="/assets/sql/income_vs_debt_predictor.png" />

Let’s now look for the `debt` value of some random `income` value. To get the
approximated `debt` value, we query the `#!sql mindsdb.debt_model` model instead
of the `#!sql income_table` table.
...
<img height="200" src="/assets/sql/income_vs_debt_prediction.png" />
...
<img height="200" src="/assets/sql/analytics_shift.png" />
...
<img height="200" src="/assets/sql/machine_learning_lifecycle.png" />
...
- You can also help us with documentation and tutorials. Here is how you can
  contribute by writing [documentation](contribute/docs/) and
  [tutorials](contribute/tutorials/). Don't forget to follow the
