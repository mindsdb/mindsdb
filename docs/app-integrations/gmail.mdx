...
<Note>
While creating an app, add these scopes:
.../auth/userinfo.profile
.../auth/userinfo.email
openid

Then go to Credentials and Create OAuth client ID, choose app type as xxx
then you'll get a popup 'OAuth client created' and download json there
</Note>
