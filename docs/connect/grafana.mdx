...
First, Go to the `Connections` section click on `Add new connection` and Choose the `MySQL` plugin
, as shown below.
...
To finally make sure that our MindsDB database connection works, 
you can querying data in the Explore view. To work around this, use the text edit mode to write your queries.
