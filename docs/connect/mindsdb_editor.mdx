...
description: MindsDB provides a SQL Editor, so you don't need to download additional SQL clients to connect to MindsDB.
---

There are two ways you can use the Editor, as below.

<Tabs>
  <Tab title="How to Use the MindsDB SQL Editor">
