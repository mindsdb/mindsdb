---
title: Building a Application Handler
sidebarTitle: Building a Aplication Handler
---
...
| `get_tables()`         | It lists and returns all the available tables. Each handler decides what a *table* means for the underlying system when interacting with it from the data layer. Typically, these are actual data entities.   |
