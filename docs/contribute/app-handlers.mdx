...
The `connection_args` dictionary contains all of arguments used to establish the connection along with their descriptions, types, labels and whether they are required or not.

Here is an example of the `connection_args` dictionary from the [GitHub handler](https://github.com/mindsdb/mindsdb/tree/staging/mindsdb/integrations/handlers/github_handler):
...
Here is an example of the `connection_args_example` dictionary from the [GitHub handler](https://github.com/mindsdb/mindsdb/tree/staging/mindsdb/integrations/handlers/github_handler).
...
A few of these variables are defined in another file called `__about__.py`. This file is imported in the `__init__.py` file.

Here is an example of the `__init__.py` file for the [GitHub handler](https://github.com/mindsdb/mindsdb/tree/staging/mindsdb/integrations/handlers/github_handler).
...
The `__about__.py` file for the same [GitHub handler](https://github.com/mindsdb/mindsdb/tree/staging/mindsdb/integrations/handlers/github_handler) contains the following variables:
...
* [GitHub handler](https://github.com/mindsdb/mindsdb/tree/staging/mindsdb/integrations/handlers/github_handler) 
* [TwitterHandler](https://github.com/mindsdb/mindsdb/blob/staging/mindsdb/integrations/handlers/twitter_handler)
