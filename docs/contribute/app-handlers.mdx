...
Here is an example of the `connection_arg` dictionary from the [GitHub handler](https://github.com/mindsdb/mindsdb/tree/staging/mindsdb/integrations/handlers/github_handler):
