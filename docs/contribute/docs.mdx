...
description: This section gets you started on how to contribute to the MindsDB documentation.
---
...
<Warning>
  **Getting an Error?**
  If you get an error saying `no such file or directory: C:/Users/Username/.mintlify/mint/client`, follow the steps below:
