...
This tutorial is to showcase how [MindsDB](https://docs.mindsdb.com) can be used to solve this problem. We will explore how you can use a machine learning model to classify positive and negative cases in predicitng loan default. MindsDB allows you to train your model from a .CSV format directly, and we will:
...
Now that you have created your prdictor model, now it is time to...
