...
You are free to create your content. However, you should include in your
tutorial all the chapters listed here.
...
Here you use the [`CREATE PREDICTOR`](/sql/create/predictor/) command to create
a predictor.
