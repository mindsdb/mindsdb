...
<Tip>
If you installed MindsDB locally via pip, you need to install all handler dependencies manually. To do so, go to the handler's folder (mindsdb/integrations/handlers/s3_handler) and run this command: `pip install -r requirements.txt` .
</Tip>
