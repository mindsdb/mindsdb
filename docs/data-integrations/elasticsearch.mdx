...
> **NOTE** : There are certain limitations that need to be taken into account when issuing queries to Elasticsearch. Given below is a detailed guide on what these limitations are,
