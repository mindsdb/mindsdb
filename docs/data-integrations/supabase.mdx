...
This is the implementation of the Supabase data integration for MindsDB.
...
```sql
CREATE DATABASE example_supabase_data     --- display name for the database
WITH ENGINE = 'supabase',                 --- name of the MindsDB handler
PARAMETERS = {
  "host": "hostname",                     --- host name or IP address
  "port": 5432,                           --- port used to make TCP/IP connection
  "user": "root",                         --- databse user
  "password": "root",                     --- database password
  "database": "postres"                   --- database name
};
```
