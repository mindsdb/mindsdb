...
- `schema` Schema to which your table belongs.
...
<Note>
  If you are using YugabyteDB Cloud with MindsDB Cloud, you need to add
  `0.0.0.0\0` to `allow IP list` for accessing it publicly.
