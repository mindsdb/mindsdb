...
<CardGroup cols={3}>
    ...
    <Card title="CREATE DATABASE" icon="link" href="/sql/create/jobs">Find out how to connect a data source.</Card>
    <Card title="Data Sources" icon="link" href="/data-sources-overview">Check out available data sources.</Card>
