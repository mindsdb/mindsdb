...
MindsDB provides various [data and application handlers](https://github.com/mindsdb/mindsdb/tree/main/mindsdb/integrations/handlers) that let you connect any data source and make use of your data to finetune models or make predictions. The types of data sources include databases, vector stores, and applications.
