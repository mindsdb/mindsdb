...
<div style={{ display: "flex", justifyContent: "center", gap: "1rem", flexWrap: "wrap" }}>
  <div style={{ width: "500px" }}>
    <Card title="Developer Experience (MindsDB Federated Query Engine)" href="/mindsdb">
      I want to use the Federated Query Engine to build AI features that learn from my data and answer questions intelligently.
        <br></br><br></br>
