...
To run example queries, use the following [CSV file](https://raw.githubusercontent.com/mindsdb/mindsdb/staging/tests/unit/ml_handlers/data/anomaly_detection.csv).
