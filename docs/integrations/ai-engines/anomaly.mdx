...
# Example usage
To run example queries, use the [Anomoly Detection dataset](https://github.com/mindsdb/mindsdb/blob/staging/tests/unit/ml_handlers/data/anomaly_detection.csv)
