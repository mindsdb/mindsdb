...
<Tip>
The available models include [OpenAI](/integrations/ai-engines/openai) models, like `gpt-3` or `gpt-4`, and [Anthropic](/integrations/ai-engines/anthropic) models, like `claude-1` or 1claude-2. Please note that you need to provide an API key for the model you choose.
</Tip>
