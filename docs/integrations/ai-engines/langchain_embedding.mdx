...
* `engine` is a required parameter. It defined the AI engine to be used.
...
* `input_columns` is an optional parameter. It defines the columns to be processed by the embedding model.
