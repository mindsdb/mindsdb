...
Lightwood is the default AI engine used in MindsDB. It deals with [classification](/sql/tutorials/customer-churn), [regression](/sql/tutorials/home-rentals), and [time-series](/sql/tutorials/house-sales-forecasting) problems in machine learninig.
...
Under the hood, the model splits data into the training and testing sets, having an 80-20 ratio. The split is done using random sampling without replacement, stratified on the target column. Doing so, it determines the accuracy of the model.
...
To learn more about Lightwood philosophy, follow [this link](https://lightwood.io/lightwood_philosophy.html).
...
<Note>
You can visit the comprehensive [Lightwood docs here](https://lightwood.io/).
</Note>
