...
![Create_model1](https://raw.githubusercontent.com/mindsdb/mindsdb/staging/docs/assets/tutorials/createmodel1.png)
...
Select the model to make sure that the training status is complete.
...
![select_model](https://raw.githubusercontent.com/mindsdb/mindsdb/staging/docs/assets/tutorials/3.select_predictor.png)

You can also use the `DESCRIBE` syntax to verify the model's status.
...
![describe](https://raw.githubusercontent.com/mindsdb/mindsdb/staging/docs/assets/tutorials/4.describe.png)
...
![select_prediction](https://raw.githubusercontent.com/mindsdb/mindsdb/staging/docs/assets/tutorials/5.select_prediction.png)
...
![prediction2](https://raw.githubusercontent.com/mindsdb/mindsdb/staging/docs/assets/tutorials/10.select_prediction.png)
