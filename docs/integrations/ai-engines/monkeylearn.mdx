...
<p align="center">
  <img src="/docs/assets/tutorials/monkeylearn/1.create_ml.png" />
</p>
...
<p align="center">
  <img src="/docs/assets/tutorials/monkeylearn/createmodel1.png" />
</p>
...
| `your_api_key`                         | The API Key of the model provided by MonkeyLearn.        | 
| `model_id`                             | The respective model's ID you want to make use of.       | 
| `input column`                         | Specifies the input column fed to the model              | 
...
<p align="center">
  <img src="/docs/assets/tutorials/monkeylearn/4.describe.png" />
</p>
...
<p align="center">
  <img src="/docs/assets/tutorials/monkeylearn/5.select_prediction.png" />
</p>
...
<p align="center">
  <img src="/docs/assets/tutorials/monkeylearn/10.select_prediction.png" />
</p>
