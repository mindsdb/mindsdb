...
3. Obtain the OpenAI or Writer API key required to deploy and use this models within MindsDB. Follow the instructions for obtaining the API key in OpenAI docs or Writer docs.
