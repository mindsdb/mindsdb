...
<Steps>
  <Step title="Sign in to Microsoft and fill in the bot data">
  ...
  <Step title="Set up the Azure portal">
  ...
  <Step title="Set up the MindsDB editor">
  ...
  <Step title="Set up the Microsoft Bot Framework portal">
  ...
  <Step title="Set up the Microsoft Teams">
...
Learn more about [chatbots here](/mindsdb_sql/agents/chatbot).
