...
- `pluralApiIds`: List of plural API IDs for the collections.

## Key Features

The Strapi Handler supports the following SQL operations:
...
- `INSERT`: Add new data to a collection (requires necessary permissions).
- `UPDATE`: Modify existing data in a collection (requires necessary permissions).
