...
* `host`: the hostname or IP address of the Amazon Aurora DB cluster.
...
The optional arguments that can be used are:
...
<Tip>
If you want to switch to a different database, you can include it in your query as:
```sql
SELECT *
