...
* `host` is the hostname or IP address of the Redshift cluster.
...
Before attempting to connect the Redshift database to MindsDB, ensure that it accepts incoming connections. Here is a [guideline](https://aws.amazon.com/premiumsupport/knowledge-center/cannot-connect-redshift-cluster) on how to do that.
