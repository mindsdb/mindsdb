...
You can connect to CKAN by creating a CKAN API client. In this handler, you can create a CKAN API client with [ckanapi](https://github.com/ckan/ckanapi).

<Info>
Some CKAN instances require you to provide an API key. You can find it in the CKAN user panel.
</Info>
