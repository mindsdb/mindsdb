...
Before proceeding, ensure the following prerequisites are met:
 ...
 2. To connect PostgreSQL to MindsDB, install the required dependencies following [this instruction](/setup/self-hosted/docker#install-dependencies).
...
Follow [this tutorial](/use-cases/predictive_analytics/house-sales-forecasting) to see more use case examples.
</Tip>
