...
<Tip>
 ...
 2. If running locally install the dependencies by running `pip install mindsdb[postgres]`

</Tip>

### Connection

Establish a connection to your PostgreSQL database using MindsDB by executing the following SQL command:
...
* We recommend the "House Sales Forecasting" tutorial available on MindsDB's documentation.  You can access the tutorial directly at [House Sales Forecasting Tutorial](https://docs.mindsdb.com/sql/tutorials/house-sales-forecasting). 