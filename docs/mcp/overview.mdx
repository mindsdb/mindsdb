...
MindsDB is an MCP server that enables you to connect and unify your data within MindsDB and subsequently pass it via a single MCP server to MCP client apps so that users can ask questions over federated data.
