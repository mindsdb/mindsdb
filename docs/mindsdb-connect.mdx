...
<CardGroup cols={2}>
    ...
    <Card title="Configure AI/ML Frameworks" icon="link" href="/mindsdb_sql/sql/create/ml-engine">Use SQL to configure any of the available AI/ML frameworks.</Card>
    <Card title="Deploy AI/ML models" icon="link" href="/mindsdb_sql/sql/create/model">Use SQL to deploy models within MindsDB to get forecasts and predictions.</Card>
