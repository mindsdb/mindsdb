...
Alternatively, you can install MindsDB locally via pip or Docker, following the instructions available under the **Self-Hosted** subsection of the **Deployment Options** section. If you choose these options, you can access the editor via `127.0.0.1:47334` in your browser.
...
<Tip>
Here is [a video](https://www.loom.com/share/a8938acb6c6b47f98cb3225ede3d33b5) that showcases all the features of the MindsDB GUI editor.
</Tip>
