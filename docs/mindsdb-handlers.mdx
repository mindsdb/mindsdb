...
<Tip>
Go ahead and implement a handler for the database of your choice! [Here](/contribute/integrations/) you'll find instructions on how to implement a database handler.
</Tip>
...
Inherit from the [`DatabaseHandler`](https://github.com/mindsdb/mindsdb/blob/staging/mindsdb/integrations/libs/base.py#L102) class when adding a new database handler. For more info, visit our [doc page here](/contribute/integrations/).
