...
<Steps>
  ...
  <Step title="Unify">
    ...
    Store the unified data into [views](/mindsdb_sql/sql/create/view) or [knowledge bases](/mindsdb_sql/knowledge_bases/overview) to ensure easy access with no need for ETL.
