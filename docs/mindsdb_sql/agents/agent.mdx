...
In this example, let's create an embedding model (using [OpenAI as an engine](/integrations/ai-engines/openai)) for the knowledge base. Note that this step is optional, as knowledge bases provide default embedding model.
