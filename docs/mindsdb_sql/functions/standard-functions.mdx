...
* <Tooltip tip="The second argument must be a constant value.">[`ADDTIME`](https://dev.mysql.com/doc/refman/8.4/en/date-and-time-functions.html#function_addtime)</Tooltip>
