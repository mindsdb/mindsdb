...
1. Not relevant with class weight between 0.0 and 0.25 and class probability of 0.25.
2. Slightly relevant with class weight between 0.25 and 0.5 and class probability of 0.5.
3. Moderately relevant with class weight between 0.5 and 0.75 and class probability of 0.75.
4. Highly relevant with class weight between 0.75 and 1.0 and class probability of 1.
