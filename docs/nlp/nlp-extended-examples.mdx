...
<AccordionGroup>
    <Accordion title="Prompt Templating with Parameters Provided at Creation Time">
        Let's create a model.
    ...
    <Accordion title="Prompt Templating with Parameters Provided at Prediction Time">
        Let's create a model.
    ...
    <Accordion title="Sentiment Classification">
        ...
        <Note>
            Please note that when querying for predictions, the maximum number of rows that can be fetched at once is 20 (`LIMIT 20`) as it is a constraint of OpenAI.
        </Note>
    </Accordion>
</AccordionGroup>
