...
<Tip>
The MindsDB's HuggingFace engine is extensible. We are actively working on adding more tasks and models.
...
<AccordionGroup>
    <Accordion title="Text Classification" defaultOpen="true">
        Completes a task of assigning a label to a text. For example, you can use it to classify a movie review as positive or negative.
        ##### Supported Models
    ...
    <Accordion title="Zero-Shot Classification" defaultOpen="true">
        Completes a task of assigning a label to a text without training on the labels.
    ...
    <Accordion title="Translation" defaultOpen="true">
        Completes a task of translating a text from one language to another. For example, you can use it to translate a text from English to French.
        ##### Supported Models
    ...
    <Accordion title="Summarization" defaultOpen="true">
        Completes a task of summarizing a text. For example, you can use it to summarize an abstract into a title.
        ##### Supported Models
...
We use the [`CREATE MODEL`](/sql/create/predictor) statement to bring the Hugging Face's models to MindsDB.
...
| `labels`         | Dependends on the model. Usually, used for Zero-Shot Classification models.                        |
