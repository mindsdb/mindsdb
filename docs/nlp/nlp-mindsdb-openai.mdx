...
OpenAI supports fine-tuning of some of its models [listed here](https://platform.openai.com/docs/guides/fine-tuning). And with MindsDB, you can easily [fine-tune an OpenAI model](/sql/api/finetune) making it more applicable to your specific use case.
</Tip>
