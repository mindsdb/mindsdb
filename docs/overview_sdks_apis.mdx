...
Alongside the SQL interface, MindsDB provides access via REST APIs, Python SDK, JavaScript SDK, and MongoQL API.
...
<CardGroup cols={1}>
    ...
    <Card title="MQL API" icon="link" href="/sdks/mongo/mindsdb-mongo-ql-overview">Use MindsDB with MongoDB syntax.</Card>
