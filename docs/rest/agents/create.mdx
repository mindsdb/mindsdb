...
curl --request POST \
  ...
  "agent": {
    ...
    "data": {
         "knowledge_bases": ["mindsdb.kb_mindsdb_docs"],
         "tables": ["mindsdb.mindsdb_docs"]
    },
    "prompt_template": "mindsdb.kb_mindsdb_docs stores documentation of MindsDB, mindsdb.mindsdb_docs stores documentation of MindsDB"
  }
}'
```
...
```json Response
{
  ...
  "data": {
    "knowledge_bases": [
      "mindsdb.kb_mindsdb_docs"
    ],
    "tables": [
      "mindsdb.mindsdb_docs"
    ]
  },
  "model": {
    "provider": "openai",
