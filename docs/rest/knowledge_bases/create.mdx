...
<ParamField body='embedding_model' type='string' required>
Defines the embedding model used to embed data in vector representation.
</ParamField>

<ParamField body='reranking_model' type='string' required>
Defines the reranking model used to rerank the search results by relevance.
</ParamField>

<ParamField body='content_columns' type='string' required>
Defines the columns that store content to be embedded.
</ParamField>

<ParamField body='metadata_columns' type='string' required>
Defines the columns that are considered metadata.
</ParamField>

<ParamField body='id_column' type='string' required>
