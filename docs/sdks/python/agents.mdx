...
Alternatively, you can get an existing agent:

```python
agent = project.agents.get('sales_agent')
```
...
updated_agent = project.agents.update('my_agent', agent)
print(updated_agent)
```
