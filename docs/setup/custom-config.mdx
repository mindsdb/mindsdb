...
<Tip>
Configure a custom authentication method for your MindsDB instance by setting `http_auth_enabled` to `True` and defining the `username` and `password` parameters.
</Tip>
