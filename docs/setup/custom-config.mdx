...
The `default_llm` parameter specifies the default LLM that will be used with [knowledge bases](/mindsdb_sql/knowledge-bases) and [agents](/mindsdb_sql/agents/agent).
