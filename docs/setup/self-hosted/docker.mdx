...
It is the lightweight Docker image of MindsDB that comes with [these integrations preloaded](https://github.com/mindsdb/mindsdb/blob/b9787ce237ccb6eb31493afdf763c419c0df5d51/setup.py#L13-L29).

* `mindsdb/mindsdb:lightwood`
It is the Docker image of MindsDB that comes with [these integrations](https://github.com/mindsdb/mindsdb/blob/b9787ce237ccb6eb31493afdf763c419c0df5d51/setup.py#L13-L29) and the Lightwood integration preloaded.

* `mindsdb/mindsdb:huggingface`
It is the Docker image of MindsDB that comes with [these integrations](https://github.com/mindsdb/mindsdb/blob/b9787ce237ccb6eb31493afdf763c419c0df5d51/setup.py#L13-L29) and the Hugging Face integration preloaded.
</Tip>
