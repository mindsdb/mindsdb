...
```bash
docker run --name mindsdb_container \
-d -p 47334:47334 mindsdb/mindsdb
```
</Tip>
...
mkdir mdb_data
docker run --name mindsdb_container \
-p 47334:47334 -v $(pwd)/mdb_data:/root/mdb_storage mindsdb/mindsdb
```
...
-v mdb_config.json:/root/mindsdb_config.json mindsdb/mindsdb
```
