...
<Note>
If you need more information on how to `DESCRIBE [MODEL]` or understand the results, feel free to ask us on the [community Slack workspace](https://mindsdb.com/joincommunity)5ai~5H66s6wlxFfBMVI6wQ).
</Note>
