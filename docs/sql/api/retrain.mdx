...
| `integration_name`                              | Optional. Name of the integration created using the [`CREATE DATABASE`](/sql/create/databases/) statement or [file upload](/sql/api/select_files/). |
