...
Here is the template of the `config.json` file that you can pass when starting your local MndsDB instance:
...
The `check_interval` parameter defines the interval in seconds between consecutive checks of the schedule table. By default, in the MindsDB Cloud Editor, it is 30 seconds.
