...
<Accordion title="How to setup Slack app and generate tokens" icon="slack" iconType="thin">
  ...
  5. Go to *App Home* under *Features* and click on the checkbox to *Allow users to send Slash commands and messages from the messages tab*.
  6. Go to *OAuth & Permissions* under *Features*.
...
Use tokens generated in points 3 and 6 to publish the chatbot to Slack.
