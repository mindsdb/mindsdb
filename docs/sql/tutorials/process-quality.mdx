...
description: "In this tutorial you will learn how to predict the quality of a mining process
using MindsDB."
---
...
3. If you are using MindsDB Cloud, make sure to add the file to a database and
   ...
   [connect via a database.](https://docs.mindsdb.com/sql/create/databases/)
