...
MindsDB provides the [RAG handler](https://github.com/mindsdb/mindsdb/tree/main/mindsdb/integrations/handlers/rag_handler) that enables you to use RAG methods for training models within MindsDB.
...
<Tip>
If you installed MindsDB locally, make sure to install all RAG dependencies by running `pip install .[rag]` or from the [requirements.txt](https://github.com/mindsdb/mindsdb/blob/main/mindsdb/integrations/handlers/rag_handler/requirements.txt) file.
</Tip>
