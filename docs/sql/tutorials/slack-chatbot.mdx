...
VALUES
    ("general", "Hey MindsDB, Thanks to you! Now I can respond to my Slack messages through SQL Queries. 🚀 "),
    ("general", "It's never been that easy to build ML apps using MindsDB!");
```
