...
sidebarTitle: Connecting MindsDB with Hugging Face for NLP operations 
---
...
The dataset we're using consists of text comments and comes from MindsDB's public PostgreSQL demo. We're using this particular dataset to perform NLP tasks because we know it holds text comments, which are perfect for text-classification operations. 
...
Got some more ideas about how MindsDB can be used to perform NLP tasks? Sign up for a free MindsDB cloud account [here](https://cloud.mindsdb.com/) and get started today!
