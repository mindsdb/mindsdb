...
![Railway App and uploaded the file](https://drive.google.com/file/d/1k6_gs82T7v_XGf2c5kj_Ax6vuMLBvNXV/view?usp=share_link)
2. Note the details listed in `Available Variables`
![Railway details](mindsdb/tutorials/images/sentiment-analysis-on-french-tweets/railwaydetails.png)
...
![select query output](mindsdb/tutorials/images/sentiment-analysis-on-french-tweets/query.png)
...
```
![query the model](mindsdb/tutorials/images/sentiment-analysis-on-french-tweets/querythemodel.png)
