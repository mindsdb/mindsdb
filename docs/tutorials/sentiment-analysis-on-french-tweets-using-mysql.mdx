...
![Railway details](docs/tutorials/images/sentiment-analysis-on-french-tweets/railwaydetails.png)
...
![select query output](docs/tutorials/images/sentiment-analysis-on-french-tweets/query.png)
...
```
![query the model](docs/tutorials/images/sentiment-analysis-on-french-tweets/querythemodel.png)
