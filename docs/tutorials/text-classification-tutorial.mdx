...
In this tutorial, you will learn how to use MindsDB and Hugging Face to classify hate speech while connected to a MySQL database. 

Before you begin, here are some core concepts to review:
