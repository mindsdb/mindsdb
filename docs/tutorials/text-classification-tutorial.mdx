...
------------------------------------------------------------+
    ...
    '> |  2 |           0 |         3 |       0 | !!!!!!! RT @UrKindOfBrand Dawg!!!! RT @80sbaby4life: You ever fuck a b*** and she                     |confused as s**t
    '> +----+-------------+-----------+---------+-----------------------------------------------------------------------------------------------------------------------------------------------+
```
---
...
***Write the actual offensive word when you run these queries, for example 'bitch', not b****. The words below that include stars were inputted as offensive words that are commonly associated with hate speech on the internet. They have been censored with astracts for this tutorial. 
...
| PRED | PRED_explain | text |
| ---- | ------------ | ---- |
| hate_speech | {"hate_speech":0.82469242811203,"neither":0.05819767713546753,"offensive":0.11710995435714722} | I hate n******' |
...
SELECT *
FROM mindsdb.hf_test
WHERE text = 'You are a dumb w****';
```

| PRED | PRED_explain | text |
| ---- | ------------ | ---- |
| offensive | {"hate_speech":0.06079000607132912,"neither":0.35908129811286926,"offensive":0.5801286697387695} | You are a dumb w**** |
