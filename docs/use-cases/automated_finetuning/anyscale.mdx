---
title: Fine-Tune the Mistral-7B Model
sidebarTitle: Mistral-7B
---
...
| 2          | assistant  | ``` CREATE DATABASE example_db WITH ENGINE = "postgres", PARAMETERS = { "user": "demo_user", "password": "demo_password", "host": "samples.mindsdb.com", ... }; ``` |
|            |            | Output:                                                                                                                                                  |
|            |            | | status |                                                                                                                                                     |
|            |            | | ------ |                                                                                                                                                     |
