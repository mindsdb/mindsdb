...
In the command line type: `!pip install git+https://github.com/mindsdb/mindsdb.git@master --user --no-cache-dir;` then press the `Run` button in the top bar and wait for the install to finish.
