...
MindsDB provides the [`CREATE PREDICTOR`](/sql/create/predictor/)
...
- [x] Go ahead and try out MindsDB by following our tutorials, and in case of
      problems, you can always
      [report an issue here](https://github.com/mindsdb/mindsdb/issues/new/choose).

- [x] Are you familiar with Python? You can then help us out in resolving open
...
- [x] Join our team! We are a fast-growing company, so we always have
