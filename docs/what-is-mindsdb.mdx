---
title: Minds[DB] - AGI's Query Engine
...
Once you've connected your data sources, you can [combine](/mindsdb_sql/sql/api/join-on), [slice it, dice it](/mindsdb_sql/sql/api/select), and [transform](/use-cases/data_enrichment/overview) it however your heart desires using good ol' standard SQL [(learn more)](/mindsdb_sql/sql/create/view). 
