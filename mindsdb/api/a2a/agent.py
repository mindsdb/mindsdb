...
class MindsDBAgent:
    ...
    def __init__(self, agent_name="my_agent", project_name="mindsdb", host="localhost", port=47334):
    ...
    def invoke(self, query, session_id) -> Dict[str, Any]:
        ...
        try:
            ...
            if "data" in data and len(data["data"]) > 0:
                ...
                return {"content": error_msg, "parts": [{"type": "text", "text": error_msg}]}
    ...
    async def stream(self, query, session_id) -> AsyncIterable[Dict[str, Any]]:
        ...
        try:
            logger.info(f"Note: MindsDB SQL API doesn't support streaming. Using regular query...")
