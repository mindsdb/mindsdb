...
from .system_tables import (
    ...
    PluginsTable, EnginesTable, MetaTableConstraintsTable, KeyColumnUsageTable, MetaColumnUsageTable, StatisticsTable,
    MetaColumnStatisticsTable, CharacterSetsTable, CollationsTable)
