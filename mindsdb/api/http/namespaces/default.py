        ...
        model=ns_conf.model(
            "response_status",
            {
                "environment": fields.String(
                    description="The name of current environment: cloud, local or other"
                ),
                "mindsdb_version": fields.String(
                    description="Current version of mindsdb"
                ),
                "auth": fields.Nested(
                    ns_conf.model(
                        "response_status_auth",
                        {
                            "confirmed": fields.Boolean(
                                description="is current user autentificated"
                            ),
                            "required": fields.Boolean(
                                description="is autentificated required"
                            ),
                            "provider": fields.Boolean(
                                description="current autentification provider: local of 3d-party"
                            ),
                        },
                    )
                ),
