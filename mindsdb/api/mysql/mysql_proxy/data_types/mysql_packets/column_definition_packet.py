...
class ColumnDefenitionPacket(Packet):
    ...
    def setup(self):
        ...
        self.table_alias = Datum("string<lenenc>", self._kwargs.get("table_alias", ""))
        self.table_name = Datum("string<lenenc>", self._kwargs.get("table_name", ""))
        self.column_alias = Datum("string<lenenc>", self._kwargs.get("column_alias", ""))
        self.column_name = Datum("string<lenenc>", self._kwargs.get("column_name", ""))
        ...
        self.column_type = Datum(
            "int<1>", self._kwargs.get("column_type", self._kwargs.get("column_type", TYPES.MYSQL_TYPE_VARCHAR))
        )
