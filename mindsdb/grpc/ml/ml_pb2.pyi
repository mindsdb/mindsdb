...
class LearnContext(_message.Message):
    __slots__ = ["context", "learn_params"]
    CONTEXT_FIELD_NUMBER: _ClassVar[int]
    LEARN_PARAMS_FIELD_NUMBER: _ClassVar[int]
    context: HandlerContext
    learn_params: LearnParams
    def __init__(self, context: _Optional[_Union[HandlerContext, _Mapping]] = ..., learn_params: _Optional[_Union[LearnParams, _Mapping]] = ...) -> None: ...
...
class PredictContext(_message.Message):
    __slots__ = ["context", "predict_params"]
    CONTEXT_FIELD_NUMBER: _ClassVar[int]
    PREDICT_PARAMS_FIELD_NUMBER: _ClassVar[int]
    context: HandlerContext
    predict_params: PredictParams
    def __init__(self, context: _Optional[_Union[HandlerContext, _Mapping]] = ..., predict_params: _Optional[_Union[PredictParams, _Mapping]] = ...) -> None: ...
...
class UpdateContext(_message.Message):
    ...
    def __init__(self, context: _Optional[_Union[HandlerContext, _Mapping]] = ..., update_params: _Optional[_Union[UpdateParams, _Mapping]] = ...) -> None: ...
