...
connection_args = OrderedDict(
    ...
    port={"type": ARG_TYPE.INT, "description": "The TCP/IP port of the Altibase server. Must be an integer."},
    user={"type": ARG_TYPE.STR, "description": "The user name used to authenticate with the Altibase server."},
    password={
        "type": ARG_TYPE.STR,
    ...
    jdbc_class={"type": ARG_TYPE.STR, "description": "The driver class of the Altibase JDBC driver"},
    jar_location={"type": ARG_TYPE.PATH, "description": "The location of the Altibase JDBC driver jar file"},
    dsn={
        "type": ARG_TYPE.STR,
