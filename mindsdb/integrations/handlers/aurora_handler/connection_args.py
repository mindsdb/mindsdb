...
connection_args = OrderedDict(
    user={"type": ARG_TYPE.STR, "description": "The user name used to authenticate with the Amazon Aurora DB cluster."},
    password={
        "type": ARG_TYPE.PWD,
    ...
    host={"type": ARG_TYPE.STR, "description": "The host name or IP address of the Amazon Aurora DB cluster."},
    port={"type": ARG_TYPE.INT, "description": "The TCP/IP port of the Amazon Aurora DB cluster. Must be an integer."},
    db_engine={
        "type": ARG_TYPE.STR,
