...
class BigCommerceHandlerTest(unittest.TestCase):
    def setUp(self):
        self.handler = BigCommerceHandler('test_bigcommerce_handler', connection_data={
            "api_base": "https://api.bigcommerce.com/stores/test-store/v3/",
            "access_token": "mock_access_token"
        })
        self.patcher = patch('mindsdb.integrations.handlers.bigcommerce_handler.bigcommerce_handler.BigCommerceAPIClient')
    ...
    def test_check_connection_success(self):
        ...
        self.mock_client_instance.get_products.return_value = [
    ...
    def test_get_tables(self):
        ...
        expected_tables = ['orders', 'products', 'customers', 'categories', 'pickups', 
                          'promotions', 'wishlists', 'segments', 'brands']
    ...
    def test_query_orders(self):
        ...
        query = ast.Select(
            targets=[ast.Star()],
            from_table=ast.Identifier("orders"),
            limit=ast.Constant(10)
        )
    ...
    def test_query_with_filter(self):
        ...
        query = ast.Select(
            ...
            where=ast.BinaryOperation(
                "=",
                args=[ast.Identifier("id"), ast.Constant(1)]
            ),
            limit=ast.Constant(10)
        )
    ...
    def test_connect_missing_parameters(self):
        ...
        handler = BigCommerceHandler('test_handler', connection_data={
