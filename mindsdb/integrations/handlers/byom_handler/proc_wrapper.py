...
def find_model_class(module):
    ...
    for _, cls in inspect.getmembers(module, inspect.isclass):
        ...
        funcs = [name for name, _ in inspect.getmembers(cls, inspect.isfunction)]
...
def get_methods_info(module):
    ...
    for method_name, method in inspect.getmembers(module, inspect.isfunction):
        ...
        input_params = [{"name": name, "type": param.annotation.__name__} for name, param in sig.parameters.items()]
        methods[method_name] = {"input_params": input_params, "output_type": sig.return_annotation.__name__}
    return methods
