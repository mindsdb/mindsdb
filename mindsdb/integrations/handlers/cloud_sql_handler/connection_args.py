...
connection_args = OrderedDict(
    ...
    host={"type": ARG_TYPE.STR, "description": "The host name or IP address of the Google Cloud SQL instance."},
    port={"type": ARG_TYPE.INT, "description": "The TCP/IP port of the Google Cloud SQL instance. Must be an integer."},
    db_engine={
        "type": ARG_TYPE.STR,
...
connection_args_example = OrderedDict(
    db_engine="mysql", host="53.170.61.16", port=3306, user="root", password="password", database="database"
)
