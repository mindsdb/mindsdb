...
class CoinBaseAggregatedTradesTableTest(unittest.TestCase):
    def test_get_columns_returns_all_columns(self):
        ...
        # Order matters.
        expected_columns = ["symbol", "low", "high", "open", "close", "volume", "timestamp", "timestamp_iso"]
    ...
    def test_select_returns_all_columns(self):
        ...
        select_all = ast.Select(
            targets=[Star()], from_table="coinbase_candle_data", where='coinbase_candle_data.symbol = "BTC-USD"'
        )
