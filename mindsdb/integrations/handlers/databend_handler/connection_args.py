...
connection_args = OrderedDict(
    user={"type": ARG_TYPE.STR, "description": "The user name used to authenticate with the Databend warehouse."},
    password={
        "type": ARG_TYPE.PWD,
    ...
    port={"type": ARG_TYPE.INT, "description": "The TCP/IP port of the ClickHouse server."},
)

connection_args_example = OrderedDict(
    host="some-url.aws-us-east-2.default.databend.com", port=443, user="root", password="password", database="test_db"
)
