...
connection_args = OrderedDict(
    host={"type": ARG_TYPE.STR, "description": "The host name or IP address of the Apache Derby server/database."},
    port={"type": ARG_TYPE.INT, "description": "Specify port to connect to Apache Derby."},
    database={
        "type": ARG_TYPE.STR,
        "description": """
