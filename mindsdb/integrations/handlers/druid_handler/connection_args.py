...
connection_args = OrderedDict(
    ...
    path={"type": ARG_TYPE.STR, "description": "The query path.", "required": True, "label": "path"},
    scheme={
        "type": ARG_TYPE.STR,
...
connection_args_example = OrderedDict(host="localhost", port=8888, path="/druid/v2/sql/", scheme="http")
