...
connection_args = OrderedDict(
    bucket={"type": ARG_TYPE.STR, "description": "The name of the GCS bucket.", "label": "GCS Bucket"},
...
connection_args_example = OrderedDict(bucket="my-bucket", service_account_keys="/Users/sam/Downloads/svc.json")
