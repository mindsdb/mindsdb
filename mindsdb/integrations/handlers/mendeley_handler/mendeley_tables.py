    ...
    def select(self, query: ast.Select) -> pd.DataFrame:
        ...
        for op, arg1, arg2 in conditions:
            if arg1 in ["arxiv", "doi", "isbn", "issn", "pmid", "scopus", "filehash"]:
                ...
                result = self.handler.call_mendeley_api(method_name="identifier_search", params=params)
                ...
                result = self.handler.call_mendeley_api(method_name="get", params=params)
                ...
                result = self.handler.call_mendeley_api(method_name="advanced_search", params=params)
