...
class TestChatsTable(unittest.TestCase):
    ...
    def test_select_star_for_single_chat_returns_all_columns(self):
        ...
        with patch.object(self.api_handler.connect(), "get_chat", return_value=ms_teams_handler_config.TEST_CHAT_DATA):
            ...
            select_all = ast.Select(
                ...
                targets=[Star()],
                from_table="chats",
                where=BinaryOperation(op="=", args=[Identifier("id"), Constant("test_id")]),
            )
    ...
    def test_select_star_for_all_chats_returns_all_columns(self):
        # patch the api handler to return the chat data
        with patch.object(
            self.api_handler.connect(), "get_chats", return_value=ms_teams_handler_config.TEST_CHATS_DATA
        ):
            chats_table = ChatsTable(self.api_handler)
...
class TestChatMessagesTable(unittest.TestCase):
    ...
    def test_select_star_for_single_chat_returns_all_columns(self):
        ...
        with patch.object(
            self.api_handler.connect(), "get_chat_message", return_value=ms_teams_handler_config.TEST_CHAT_MESSAGE_DATA
        ):
            chat_messages_table = ChatMessagesTable(self.api_handler)
            ...
            select_all = ast.Select(
                ...
                where=[
                    BinaryOperation(op="=", args=[Identifier("id"), Constant("test_id")]),
                    BinaryOperation(op="=", args=[Identifier("chatId"), Constant("test_chat_id")]),
                ],
            )
    ...
    def test_select_star_for_multiple_chats_returns_all_columns(self):
        ...
        with patch.object(
            ...
            "get_chat_messages",
            return_value=ms_teams_handler_config.TEST_CHAT_MESSAGES_DATA,
        ):
            chat_messages_table = ChatMessagesTable(self.api_handler)
            ...
            select_all = ast.Select(
                ...
                targets=[Star()],
                from_table="chat_messages",
                where=[BinaryOperation(op="=", args=[Identifier("chatId"), Constant("test_chat_id")])],
            )
    ...
    def test_insert_chat_message_calls_correct_method_in_client(self):
        ...
        with patch.object(self.api_handler.connect(), "send_chat_message", return_value=None) as mock_send_chat_message:
            ...
            insert = ast.Insert(
                ...
                values=[("test_chat_id", "test_message", "test_subject")],
            )
            ...
            mock_send_chat_message.assert_called_once_with(
                chat_id="test_chat_id", message="test_message", subject="test_subject"
            )
...
class TestChannelsTable(unittest.TestCase):
    ...
    def test_select_star_for_single_channel_returns_all_columns(self):
        ...
        with patch.object(
            self.api_handler.connect(), "get_channel", return_value=ms_teams_handler_config.TEST_CHANNEL_DATA
        ):
            channels_table = ChannelsTable(self.api_handler)
            ...
            select_all = ast.Select(
                ...
                where=[
                    BinaryOperation(op="=", args=[Identifier("id"), Constant("test_id")]),
                    BinaryOperation(op="=", args=[Identifier("teamId"), Constant("test_team_id")]),
                ],
            )
    ...
    def test_select_star_for_all_channels_returns_all_columns(self):
        # patch the api handler to return the channel data
        with patch.object(
            self.api_handler.connect(), "get_channels", return_value=ms_teams_handler_config.TEST_CHANNELS_DATA
        ):
            channels_table = ChannelsTable(self.api_handler)
...
class TestChannelMessagesTable(unittest.TestCase):
    ...
    def test_get_columns_returns_all_columns(self):
        ...
        self.assertListEqual(
            channel_messages_table.get_columns(), ms_teams_handler_config.CHANNEL_MESSAGES_TABLE_COLUMNS
        )
    ...
    def test_select_star_for_single_channel_message_returns_all_columns(self):
        ...
        with patch.object(
            self.api_handler.connect(),
            "get_channel_message",
            return_value=ms_teams_handler_config.TEST_CHANNEL_MESSAGE_DATA,
        ):
            channel_messages_table = ChannelMessagesTable(self.api_handler)
            ...
            select_all = ast.Select(
                ...
                where=[
                    BinaryOperation(op="=", args=[Identifier("id"), Constant("test_id")]),
                    BinaryOperation(
                        op="=", args=[Identifier("channelIdentity_channelId"), Constant("test_channel_id")]
                    ),
                    BinaryOperation(op="=", args=[Identifier("channelIdentity_teamId"), Constant("test_team_id")]),
                ],
            )
    ...
    def test_select_star_for_all_channel_messages_returns_all_columns(self):
        ...
        with patch.object(
            ...
            return_value=ms_teams_handler_config.TEST_CHANNEL_MESSAGES_DATA,
        ):
            channel_messages_table = ChannelMessagesTable(self.api_handler)
    ...
    def test_insert_channel_message_calls_correct_method_in_client(self):
        ...
        # patch the api handler to return the channel message data
        with patch.object(
            self.api_handler.connect(), "send_channel_message", return_value=None
            ...
            insert = ast.Insert(
                ...
                values=[("test_team_id", "test_channel_id", "test_message", "test_subject")],
            )
            ...
            mock_send_channel_message.assert_called_once_with(
                group_id="test_team_id", channel_id="test_channel_id", message="test_message", subject="test_subject"
            )
