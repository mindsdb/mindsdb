...
SERVICE_URL = r"https://api.npms.io/"
API_BASE_URL = path.join(SERVICE_URL, "v2/package/")


class NPM:

    def __init__(self, package_name: str, limit: int = None) -> None:
        """initializer method"""
        self.name: str = package_name
        self.limit = limit
        self.endpoint: str = path.join(API_BASE_URL, package_name)
