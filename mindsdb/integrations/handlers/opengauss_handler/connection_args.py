...
connection_args = OrderedDict(
    user={"type": ARG_TYPE.STR, "description": "The user name used to authenticate with the openGauss server."},
    password={
        "type": ARG_TYPE.PWD,
    ...
    port={"type": ARG_TYPE.INT, "description": "The TCP/IP port of the openGauss server. Must be an integer."},
)

connection_args_example = OrderedDict(
    host="127.0.0.1", port=5432, user="mindsdb", password="password", database="database"
)
