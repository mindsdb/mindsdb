...
connection_args = OrderedDict(
    host={"type": ARG_TYPE.STR, "description": "The host name or IP address of the Apache Pinot cluster."},
    broker_port={
        "type": ARG_TYPE.INT,
    ...
    path={"type": ARG_TYPE.STR, "description": "The query path."},
    scheme={
        "type": ARG_TYPE.STR,
...
connection_args_example = OrderedDict(
    host="localhost", broker_port=8000, controller_port=9000, path="/query/sql", scheme="http"
)
