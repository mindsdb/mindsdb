...
class PlaidHandler(APIHandler):
    ...
    def __init__(self, name=None, **kwargs):
        ...
        self.plaid_config = plaid.Configuration(
            ...
            api_key={"clientId": args.get("client_id"), "secret": args.get("secret")},
        )
    ...
    def check_connection(self) -> StatusResponse:
        ...
        try:
            api = self.connect()
            api.accounts_balance_get(AccountsBalanceGetRequest(access_token=self.access_token))
    ...
    def get_balance(self, params=None):
        ...
        if params.get("last_updated_datetime") is not None:
            ...
            response = self.api.accounts_balance_get(
                AccountsBalanceGetRequest(access_token=self.access_token, options=options)
            )
        else:
            response = self.api.accounts_balance_get(AccountsBalanceGetRequest(access_token=self.access_token))
