...
def create_test_documents():
    return [
        Document(page_content="This is a test document", metadata={"doc_id": "1"}),
        Document(page_content="This is also a test document", metadata={"doc_id": "2"}),
        Document(page_content="This is another test document", metadata={"doc_id": "3"}),
    ]
