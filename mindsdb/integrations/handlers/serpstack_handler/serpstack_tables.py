...
class ImageResultsTable(BaseResultsTable):
    ...
    def get_columns(self):
        return ["position", "title", "width", "height", "image_url", "type", "url", "source"]
...
class VideoResultsTable(BaseResultsTable):
    ...
    def get_columns(self):
        return ["position", "title", "url", "displayed_url", "uploaded", "snippet", "length"]
...
class NewsResultsTable(BaseResultsTable):
    ...
    def get_columns(self):
        return ["position", "title", "url", "source_name", "uploaded", "uploaded_utc", "snippet", "thumbnail_url"]
...
class ShoppingResultsTable(BaseResultsTable):
    ...
    def extract_data(self, shopping):
        return {"position": shopping.get("position"), "title": shopping.get("title"), "url": shopping.get("url")}
