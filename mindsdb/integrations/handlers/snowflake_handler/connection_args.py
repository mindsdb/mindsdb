...
connection_args = OrderedDict(
    host={"type": ARG_TYPE.STR, "description": "The Snowflake host.", "required": True, "label": "Host"},
    account={"type": ARG_TYPE.STR, "description": "The Snowflake account name.", "required": False, "label": "Server"},
    user={
        "type": ARG_TYPE.STR,
