...
connection_args = OrderedDict(
    username={"type": ARG_TYPE.STR, "description": "The user name used to authenticate with the Solr server."},
    password={
        "type": ARG_TYPE.PWD,
    ...
    port={"type": ARG_TYPE.INT, "description": "The TCP/IP port of the Solr server. Must be an integer."},
    server_path={
        "type": ARG_TYPE.STR,
        "description": "The server path connecting with the Solr server. Defaults to solr when not provided.",
    },
    collection={"type": ARG_TYPE.STR, "description": "The collection name to use for the query in the Solr server."},
    use_ssl={
        "type": ARG_TYPE.BOOL,
