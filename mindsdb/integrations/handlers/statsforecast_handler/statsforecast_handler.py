...
def get_insample_cv_results(model_args, df):
    ...
    season_length = get_season_length(model_args["frequency"]) if "season_length" not in model_args else model_args["season_length"]  # noqa
...
def choose_model(model_args, results_df):
    ...
    model_args["season_length"] = get_season_length(model_args["frequency"]) if "season_length" not in model_args else model_args["season_length"]  # noqa
