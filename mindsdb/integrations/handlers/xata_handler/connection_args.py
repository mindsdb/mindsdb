...
connection_args = OrderedDict(
    ...
    api_key={"type": ARG_TYPE.STR, "description": "personal Xata API key", "required": True, "secret": True},
    dimension={
        "type": ARG_TYPE.INT,
...
connection_args_example = OrderedDict(db_url="https://...", api_key="abc_def...", dimension=8, similarity_function="l1")
