...
class LLMReranker:
    ...
    async def acompress_documents(
        ...
        if not documents:
            log.warning("No documents provided for compression.")
            return []
    ...
    def compress_documents(
        ...
        return asyncio.run(self.acompress_documents(documents, query))
...
if __name__ == "__main__":
    reranker = LLMReranker(filtering_threshold=0.5)
    query = "What is the capital of France?"
    documents = [
        Document("The capital of France is Paris."),
        Document("The capital of Germany is Berlin."),
        Document("The capital of Italy is Rome."),
    ]
