...
class AgentsController:
    ...
    def delete_agent(self, agent_name: str, project_name: str = default_project):
        ...
        for rel in agent.skills_relationships:
            description = rel.skill.params.get('description') if rel.skill.params else None
            if description is not None and self.autogenerated_skill_prefix in description:
