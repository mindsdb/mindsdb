...
from .pydantic_ai_model_factory import get_llm_provider
...
class AgentsController:
    ...
    def _create_default_sql_skill(
        ...
        # Skills are no longer used - this method is kept for compatibility but does nothing
        return None
    ...
    def add_agent(
        ...
        # Skills are no longer used - skills parameter is ignored
        if skills:
            logger.warning("Skills parameter is deprecated and ignored. Use 'data' parameter with 'tables' and 'knowledge_bases' instead.")
    ...
    def update_agent(
        ...
        # Skills are no longer used - skill parameters are ignored
        if skills_to_add or skills_to_remove or skills_to_rewrite:
            logger.warning("Skills parameters are deprecated and ignored. Use 'data' parameter with 'tables' and 'knowledge_bases' instead.")
    ...
    def delete_agent(self, agent_name: str, project_name: str = default_project):
        ...
        # Skills are no longer used - no need to delete skills
