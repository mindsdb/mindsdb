...
class AgentsController:
    ...
    def _create_default_sql_skill(
        ...
        try:
            ...
            if existing_skill is not None and existing_skill.params is not None:
                # is autogenerated?
                if self.autogenerated_skill_prefix in existing_skill.params.get("description"):
                    self.skills_controller.delete_skill(skill_name, project_name, strict_case=True)
                    existing_skill = None
