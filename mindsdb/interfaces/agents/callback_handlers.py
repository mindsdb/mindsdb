...
class ContextCaptureCallback(BaseCallbackHandler):
    ...
    def on_retriever_end(
        self, documents: List[Any], *, run_id: str, parent_run_id: Union[str, None] = None, **kwargs: Any
    ) -> Any:
        self.context = [{"page_content": doc.page_content, "metadata": doc.metadata} for doc in documents]
...
class LogCallbackHandler(BaseCallbackHandler):
    ...
    def on_chain_start(self, serialized: Dict[str, Any], inputs: Dict[str, Any], **kwargs: Any) -> Any:
        ...
        self.logger.info("Entering new LLM chain ({} total)".format(self._num_running_chains))
    ...
    def on_chain_end(self, outputs: Dict[str, Any], **kwargs: Any) -> Any:
        ...
        self._num_running_chains -= 1
        self.logger.info("Ended LLM chain ({} total)".format(self._num_running_chains))
    ...
    def on_chain_error(self, error: Union[Exception, KeyboardInterrupt], **kwargs: Any) -> Any:
        ...
        self._num_running_chains -= 1
        self.logger.error("LLM chain encountered an error ({} running): {}".format(self._num_running_chains, error))
