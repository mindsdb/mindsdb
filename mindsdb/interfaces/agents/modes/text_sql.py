...
planning_prompt = prompts.planning_prompt_base.format(response_instruction="2.1 If there is no need for exploratory steps, describe how would you write the final query or final text response to the user. and that you can solve this in one step.")
...
class AgentResponse(BaseModel):
    ...
    type: str = Field(..., description="Type of query: "
