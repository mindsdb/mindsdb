...
class Predictor(Base):
    ...
    company_id = Column(String, default=DEFAULT_COMPANY_ID)
...
class QueryContext(Base):
    ...
    company_id: str = Column(String, default=DEFAULT_COMPANY_ID)
    user_id: str = Column(String, default=DEFAULT_USER_ID)
