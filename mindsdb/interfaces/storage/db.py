...
class Predictor(Base):
    ...
    company_id = Column(String, default="0", nullable=False)
...
class QueryContext(Base):
    ...
    company_id: str = Column(String, default="0", nullable=False)
    user_id: str = Column(String, default="0", nullable=False)
...
class LLMLog(Base):
    ...
    id: int = Column(Integer, primary_key=True)
    company_id: int = Column(String, default="0", nullable=False)
    user_id: int = Column(String, default="0", nullable=False)
