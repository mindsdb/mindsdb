...
class Batch:
    ...
    def get(self, what, flatten = True, by_buckets = False):
        ...
        if flatten:
            ...
            for col in self.sampler.model_columns:
                ...
                if self.sampler.stats[col][KEYS.DATA_TYPE] == DATA_TYPES.SEQUENTIAL:
                    continue
    ...
    def getFullTextInput(self):
        ...
        ret = {}
        for col in self.sampler.model_columns:
            if col not in self.xy[what] or self.sampler.stats[col][KEYS.DATA_TYPE] != DATA_TYPES.SEQUENTIAL:
                continue
