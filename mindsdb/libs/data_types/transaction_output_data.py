...
class PredictTransactionOutputData():
    ...
    def __iter__(self):
        for i, cell in enumerate(self.data[self.transaction.persistent_model_metadata.columns[0]]):
    ...
    def __len__(self):
        return len(self.data[self.transaction.persistent_model_metadata.columns[0]])
