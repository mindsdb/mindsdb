        ...
        for column in input_data.columns:
            ...
            if data_type == DATA_TYPES.NUMERIC:
                ...
                if data_stype == DATA_SUBTYPES.INT:
                    ...
                    input_data.train_df[column] = input_data.train_df[column].apply(round)
                    input_data.test_df[column] = input_data.test_df[column].apply(round)
                    input_data.validation_df[column] = input_data.validation_df[column].apply(round)
