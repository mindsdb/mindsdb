    def _compute_value_distribution_score(stats, columns, col_name):
        """
    ...
    def _compute_duplicates_score(stats, columns, col_name):
        """
    ...
    def _compute_empty_cells_score(stats, columns, col_name):
        """
    ...
    def _compute_data_type_dist_score(stats, columns, col_name):
        """
    ...
    def _compute_z_score(stats, columns, col_name):
        """
    ...
    def _compute_lof_score(stats, columns, col_name):
        """
    ...
    def _compute_similariy_score(stats, columns, col_name):
        """
    ...
    def _compute_clf_based_correlation_score(stats, columns, col_name):
        """
    ...
    def _compute_consistency_score(stats, col_name):
        """
    ...
    def _compute_redundancy_score(stats, col_name):
        """
    ...
    def _compute_variability_score(stats, col_name):
        """
    ...
    def _compute_data_quality_score(stats, col_name):
        """
