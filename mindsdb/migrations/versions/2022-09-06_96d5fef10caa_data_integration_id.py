...
def upgrade():
    ...
    with op.batch_alter_table("predictor", schema=None) as batch_op:
        batch_op.alter_column("integration_id", existing_type=sa.INTEGER(), nullable=False)
...
def downgrade():
    ...
    with op.batch_alter_table("predictor", schema=None) as batch_op:
        ...
        batch_op.alter_column("integration_id", existing_type=sa.INTEGER(), nullable=True)
