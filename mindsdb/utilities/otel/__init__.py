...
if OTEL_ENABLED:
    try:
        from mindsdb.utilities.otel.prepare import trace as trace
        from mindsdb.utilities.otel.metric_handlers import (
            increment_otel_query_request_counter as increment_otel_query_request_counter,
        )
    except Exception:
        pass
