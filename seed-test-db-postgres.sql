...
truncate public.rentals;
DROP TABLE IF EXISTS public.test_data;

COPY public.rentals (number_of_rooms, number_of_bathrooms, sqft, location, days_on_market, initial_price, neighborhood, rental_price) FROM stdin;
