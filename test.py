...
#'rental_price',
#mdb.learn(to_predict=['neighborhood'],from_data="https://mindsdb-example-data.s3.eu-west-2.amazonaws.com/home_rentals.csv",use_gpu=False,stop_training_in_x_seconds=300, backend='lightwood', unstable_parameters_dict={'use_selfaware_model':True})
