...
class TestHTTP:
    ...
    def test_utils(self, util_uri):
        ...
        # path = Path(HTTP_API_ROOT).joinpath(util_uri)
        path = f"{HTTP_API_ROOT}/{util_uri}"
        response = requests.get(path)
        assert response.status_code == 200

        # response = requests.get(f'{HTTP_API_ROOT}/util/ping_native')
        # assert response.status_code == 200

        # response = requests.get(f'{HTTP_API_ROOT}/config/vars')
        # assert response.status_code == 200
    ...
    #         # Get the original
    #         res = requests.get(f'{HTTP_API_ROOT}/config/integrations/{name}')
    #         assert res.status_code == 200
    ...
    #         # Modify it
    #         res = requests.post(
    #             f'{HTTP_API_ROOT}/config/integrations/{name}',
    ...
    #         res = requests.post(f'{HTTP_API_ROOT}/config/integrations/{name}', json={'params': integration})
    #         res = requests.get(f'{HTTP_API_ROOT}/config/integrations/{name}')
    #         assert res.status_code == 200
    #         modified_integration = res.json()
    #         for k in integration:
    ...
    #     res = requests.delete(f'{HTTP_API_ROOT}/config/integrations/test_integration')
    #     assert res.status_code == 200
