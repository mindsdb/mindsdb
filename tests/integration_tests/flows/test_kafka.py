...
class KafkaTest(unittest.TestCase):
    ...
    def upload_ds(self, name):
        df = pd.DataFrame({
            ...
            'order': [x for x in range(100, 210)] + [x for x in range(100, 210)],
            'x1': [x for x in range(100, 210)] + [x for x in range(100, 210)],
            'x2': [x * 2 for x in range(100, 210)] + [x * 2 for x in range(100, 210)],
            'y': [x * 3 for x in range(100, 210)] + [x * 3 for x in range(100, 210)]
        })
