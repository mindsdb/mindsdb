...
CHROMADB_HANDLER_DEPS = ["onnxruntime"]

HANDLER_RULE_IGNORES = {
    "DEP002": OPTIONAL_HANDLER_DEPS + MAIN_REQUIREMENTS_DEPS + BYOM_HANLDER_DEPS + HIVE_HANDLER_DEPS + GCS_HANDLER_DEPS + CHROMADB_HANDLER_DEPS,
