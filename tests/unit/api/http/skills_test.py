...
def test_create_skill(client):
    create_request = {"skill": {"name": "test_create_skill", "type": "Knowledge Base", "params": {"k1": "v1"}}}
...
def test_get_skill(client):
    create_request = {"skill": {"name": "test_get_skill", "type": "Knowledge Base", "params": {"k1": "v1"}}}
...
def test_post_skill_no_skill(client):
    malformed_request = {"name": "test_post_skill_no_skill", "type": "Knowledge Base", "params": {"k1": "v1"}}
...
def test_post_skill_no_name(client):
    malformed_request = {"skill": {"type": "Knowledge Base", "params": {"k1": "v1"}}}
...
def test_post_skill_no_type(client):
    malformed_request = {"skill": {"name": "test_post_skill_no_type", "params": {"k1": "v1"}}}
...
def test_put_skill_create(client):
    create_request = {"skill": {"name": "test_put_skill_create", "type": "Knowledge Base", "params": {"k1": "v1"}}}

    create_response = client.put(
        "/api/projects/mindsdb/skills/test_put_skill_create", json=create_request, follow_redirects=True
    )
    assert create_response.status_code == HTTPStatus.CREATED
    created_skill = create_response.get_json()
...
def test_put_skill_update(client):
    ...
    create_response = client.put(
        "/api/projects/mindsdb/skills/test_put_skill_update", json=create_request, follow_redirects=True
    )
    assert create_response.status_code == HTTPStatus.CREATED
    ...
    create_response = client.put(
        "/api/projects/mindsdb/skills/test_put_skill_update", json=update_request, follow_redirects=True
    )
    ...
    expected_skill = {
        ...
        "name": "test_put_skill_update_new",
        "type": "New Type",
        "params": {"k2": "v2.1", "k3": "v3"},
    }
    assert _clear_skill(updated_skill) == expected_skill


def test_put_skill_no_skill(client):
    malformed_request = {"name": "test_put_skill_no_skill", "type": "Knowledge Base", "params": {"k1": "v1"}}

    update_response = client.put(
        "/api/projects/mindsdb/skills/test_put_skill_no_skill", json=malformed_request, follow_redirects=True
    )
...
def test_put_skill_no_project(client):
    ...
    update_response = client.put(
        "/api/projects/goop/skills/test_put_skill_no_project", json=update_request, follow_redirects=True
    )
    assert update_response.status_code == HTTPStatus.NOT_FOUND


def test_delete_skill(client):
    create_request = {"skill": {"name": "test_delete_skill", "type": "Knowledge Base", "params": {"k1": "v1"}}}
