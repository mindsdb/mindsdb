...
class TestMySQLHandler(BaseDatabaseHandlerTest, unittest.TestCase):
    ...
    def test_meta_get_tables_returns_response(self):
        ...
        sample_data = [
            {"table_name": "customers", "table_schema": "test_db", "table_type": "BASE TABLE", 
             "table_description": "Customer information", "row_count": 100},
            {"table_name": "orders", "table_schema": "test_db", "table_type": "BASE TABLE", 
             "table_description": None, "row_count": 500},
            {"table_name": "products", "table_schema": "test_db", "table_type": "BASE TABLE", 
             "table_description": None, "row_count": 42},
        ]
    ...
    def test_meta_get_columns_returns_response(self):
        ...
        sample_data = [
            {"table_name": "customers", "column_name": "id", "data_type": "int",
             "column_description": None, "column_default": None, "is_nullable": 0},
            {"table_name": "customers", "column_name": "name", "data_type": "varchar",
             "column_description": None, "column_default": None, "is_nullable": 1},
            {"table_name": "products", "column_name": "sku", "data_type": "varchar",
             "column_description": "Product SKU", "column_default": None, "is_nullable": 0},
        ]
        self._test_meta_method_with_filter(
    ...
    def test_meta_get_column_statistics_returns_response(self):
        ...
        sample_data = [
            {"TABLE_NAME": "customers", "COLUMN_NAME": "id", "MOST_COMMON_VALUES": None,
             "MOST_COMMON_FREQUENCIES": None, "NULL_PERCENTAGE": 0.0, "MINIMUM_VALUE": "1",
             "MAXIMUM_VALUE": "100", "DISTINCT_VALUES_COUNT": 100},
            {"TABLE_NAME": "customers", "COLUMN_NAME": "name", "MOST_COMMON_VALUES": None,
             "MOST_COMMON_FREQUENCIES": None, "NULL_PERCENTAGE": 5.0, "MINIMUM_VALUE": "Alice",
             "MAXIMUM_VALUE": "Zoe", "DISTINCT_VALUES_COUNT": 95},
            {"TABLE_NAME": "products", "COLUMN_NAME": "sku", "MOST_COMMON_VALUES": None,
             "MOST_COMMON_FREQUENCIES": None, "NULL_PERCENTAGE": 0.0, "MINIMUM_VALUE": None,
             "MAXIMUM_VALUE": None, "DISTINCT_VALUES_COUNT": 42},
        ]
        self._test_meta_method_with_filter(
    ...
    def test_meta_get_foreign_keys_returns_response(self):
        ...
        sample_data = [
            {"parent_table_name": "customers", "parent_column_name": "id", 
             "child_table_name": "orders", "child_column_name": "customer_id", "constraint_name": "orders_ibfk_1"},
            {"parent_table_name": "products", "parent_column_name": "id",
             "child_table_name": "orders", "child_column_name": "product_id", "constraint_name": "orders_ibfk_2"},
        ]
        self._test_meta_method_with_filter(
