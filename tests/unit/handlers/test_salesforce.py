...
class TestSalesforceHandler(BaseHandlerTestSetup, unittest.TestCase):
    ...
    def test_get_tables(self):
        ...
        self.mock_connect.return_value = MagicMock(
            sobjects=MagicMock(describe=lambda: {"sobjects": [{"name": table} for table in mock_tables]})
        )
    ...
    def test_get_columns(self):
        ...
        self.mock_connect.return_value = MagicMock(
            sobjects=MagicMock(
                ...
                Contact=MagicMock(describe=lambda: {"fields": [{"name": column} for column in mock_columns]}),
            )
        )
        self.handler.connect()
