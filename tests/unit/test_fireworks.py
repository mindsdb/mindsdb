...
from mindsdb.integrations.handlers.fireworks_handler.fireworks_handler import FireworksHandler
...
class TestFireworks(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.handler = FireworksHandler(self.mock_model_storage, self.mock_engine_storage, connection_data={'connection_data': {}})
    ...
    def test_create_validation_without_using_clause_raises_exception(self):
        ...
        with self.assertRaisesRegex(Exception, "fireworks_ai engine requires a USING clause! Refer to its documentation for more details."):
    ...
    def test_create_validation_with_invalid_args_raises_validation_error(self):
        ...
        with self.assertRaises(ValidationError):
            self.handler.create_validation('target', args={"using": {"invalid_field": "value"}})
