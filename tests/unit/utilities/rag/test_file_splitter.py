...
def test_split_documents_pdf():
    pdf_doc = Document(
        page_content="This is a test PDF file. Let us try to do some splitting!", metadata={"extension": ".pdf"}
    )
    recursive_splitter = RecursiveCharacterTextSplitter()
    file_splitter = FileSplitter(FileSplitterConfig(recursive_splitter=recursive_splitter))
...
def test_split_documents_md():
    ...
    To be continued!
"""
    md_doc = Document(page_content=md_content, metadata={"extension": ".md"})
    headers_to_split_on = [
        ("#", "Header 1"),
        ("##", "Header 2"),
    ]
    md_text_splitter = MarkdownHeaderTextSplitter(headers_to_split_on=headers_to_split_on)
    file_splitter = FileSplitter(FileSplitterConfig(markdown_splitter=md_text_splitter))
...
"""
    ...
    file_splitter = FileSplitter(FileSplitterConfig(html_splitter=html_text_splitter))
    html_doc = Document(page_content=html_content, metadata={"extension": ".html"})
...
def test_split_documents_default():
    recursive_splitter = RecursiveCharacterTextSplitter()
    file_splitter = FileSplitter(FileSplitterConfig(recursive_splitter=recursive_splitter))
    txt_doc = Document(page_content="This is a text file!", metadata={"extension": ".txt"})
...
"""
    ...
    file_splitter = FileSplitter(FileSplitterConfig(markdown_splitter=mock_md_splitter))
    md_doc = Document(page_content=md_content, metadata={"extension": ".md"})
