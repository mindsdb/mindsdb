...
dtype_tests = [
    ...
    # FLOAT types
    {"input": [1, 2, 3], "dtype": "float64", "output": ["1.0", "2.0", "3.0"], "mysql_type": MYSQL_DATA_TYPE.FLOAT},
    {
    ...
    # INT types
    {"input": [1, 2, 3], "dtype": "int64", "output": ["1", "2", "3"], "mysql_type": MYSQL_DATA_TYPE.INT},
    {"input": [1, NA, None], "dtype": "Int64", "output": ["1", None, None], "mysql_type": MYSQL_DATA_TYPE.INT},
    # STR types
    {
    ...
    {"input": [1, 2, 3], "dtype": "string", "output": ["1", "2", "3"], "mysql_type": MYSQL_DATA_TYPE.TEXT},
    {"input": [1, 2, 3], "dtype": "object", "output": ["1", "2", "3"], "mysql_type": MYSQL_DATA_TYPE.TEXT},
    {"input": [1, NA, None], "dtype": "object", "output": ["1", None, None], "mysql_type": MYSQL_DATA_TYPE.TEXT},
    {"input": ["1", NA, None], "dtype": "object", "output": ["1", None, None], "mysql_type": MYSQL_DATA_TYPE.TEXT},
]
...
str_test_cases = [
    {"input": ["a", 1, NA, None, Decimal("4.4")], "dtype": "object", "output": ["a", "1", None, None, "4.4"]},
    {"input": ["a", 1, NA, None, Decimal("4.4")], "dtype": "string", "output": ["a", "1", None, None, "4.4"]},
    {"input": [1, 2, 3], "dtype": "string", "output": ["1", "2", "3"]},
    {"input": [1, 2, 3], "dtype": "int64", "output": ["1", "2", "3"]},
    {"input": [1, 2, 3], "dtype": "object", "output": ["1", "2", "3"]},
    {"input": [1, NA, None], "dtype": "object", "output": ["1", None, None]},
    {"input": ["1", NA, None], "dtype": "object", "output": ["1", None, None]},
]
_map_test_case(
    str_test_cases,
...
_map_test_case(bool_test_cases, [MYSQL_DATA_TYPE.BOOL, MYSQL_DATA_TYPE.BOOLEAN])

float_test_cases = [
    {"input": [1, 2, 3], "dtype": "float64", "output": ["1.0", "2.0", "3.0"]},
    {"input": [1.1, 2.2, 3.3, Decimal("4.4")], "dtype": "float64", "output": ["1.1", "2.2", "3.3", "4.4"]},
    {"input": [1.1, NA, None, Decimal("4.4")], "dtype": "Float64", "output": ["1.1", None, None, "4.4"]},
    {"input": [1, 2, 3], "dtype": "object", "output": ["1", "2", "3"]},
    {"input": [1.1, 2.2, 3.3, Decimal("4.4")], "dtype": "object", "output": ["1.1", "2.2", "3.3", "4.4"]},
    {"input": [1.1, NA, None, Decimal("4.4")], "dtype": "object", "output": ["1.1", None, None, "4.4"]},
]
_map_test_case(float_test_cases, [MYSQL_DATA_TYPE.FLOAT, MYSQL_DATA_TYPE.DOUBLE, MYSQL_DATA_TYPE.DECIMAL])

int_test_cases = [
    {"input": [1, 2, -3], "dtype": "int64", "output": ["1", "2", "-3"]},
    {"input": [1, "2", -3], "dtype": "object", "output": ["1", "2", "-3"]},
    {"input": ["1", NA, None], "dtype": "object", "output": ["1", None, None]},
    {"input": ["1", NA, None], "dtype": "Int64", "output": ["1", None, None]},
]
_map_test_case(
    int_test_cases,
    [
...
dt_test_cases = [
    # with TZ
    {
        ...
        "dtype": "object",
        "output": ["12:30:45", "12:30:00", "12:30:45", "12:30:45", "12:30:45", None],
    ...
    },
    {
        ...
        "dtype": "object",
        "output": ["2023-01-01 12:30:45", "2023-10-16 12:30:00", "2023-10-16 00:00:00", "2023-10-15 12:30:45", None],
        "column_type": MYSQL_DATA_TYPE.DATETIME,
        "mysql_type": MYSQL_DATA_TYPE.DATETIME,
    },
    # no TZ
    {
        "input": [datetime.datetime(2023, 10, 16, 12, 30), Timestamp("2023-10-15 14:30:45.123456789"), None],
        "dtype": "object",
        "output": [
